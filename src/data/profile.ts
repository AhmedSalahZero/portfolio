...
export const profile: Profile = {
    ...
    headline:
        'I build scalable SaaS platforms, ERP-integrated systems, and mobile APIs with Laravel, Vue 3, and MySQL.',
    bio:
        "I'm a Senior Software Developer with 6+ years building production-grade SaaS platforms, " +
    ...
    avatar_url: null,
    cv_url: '/cv/ahmed-salah-cv.pdf',
    social: {
        github: 'https://github.com/AhmedSalahZero',
        linkedin: 'https://www.linkedin.com/in/ahmed-salah-a847841b5',
        twitter: null,
        website: null,
    },
    stats: [
