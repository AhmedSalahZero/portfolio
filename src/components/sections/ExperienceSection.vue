...
<template>
    <section
        ...
        id="experience"
        class="scroll-mt-20 border-t border-white/5 py-20 sm:py-28"
    >
        <div class="container-page">
            ...
            <div class="mt-12 space-y-6">
                ...
                >
                    <span
                        class="absolute left-0 top-6 h-8 w-1 rounded-r-full bg-gradient-to-b from-accent-500 to-brand-500"
                    />
                    <div
                    ...
                    >
                        ...
                        <span class="chip shrink-0 text-[11px]">{{
                            period(exp)
                        }}</span>
                    </div>
                    ...
                    <ul v-if="exp.achievements.length" class="mt-4 space-y-2">
                        ...
                        >
                            <AppIcon
                                name="check"
                                :size="16"
                                class="mt-0.5 shrink-0 text-accent-400"
                            />
                            <span>{{ item }}</span>
                        </li>
                    </ul>
