    ...
    public function run(): void
    {
        $rows = [
            [
                ...
                'end_date' => null,
                'is_current' => true,
                'description' => 'Architect and deliver production SaaS platforms, enterprise finance suites, and mobile APIs with Laravel and Vue 3.',
                'achievements' => [
            ...
            [
                ...
                'end_date' => null,
                'is_current' => true,
                'description' => 'Built backends, mobile APIs, and integrations for ride-hailing, marketplace, and fintech products.',
                'achievements' => [
